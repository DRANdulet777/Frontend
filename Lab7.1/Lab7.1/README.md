...
В проект был добавлен ErrorBoundary:
- компонент ErrorBoundary для перехвата ошибок;
- вывод понятного сообщения при ошибке загрузки страницы;
- кнопка для повторной попытки загрузки страницы;
- обработка ошибок для лениво загружаемых страниц.

/src/pages/Profile.tsx -- искуственно сломаная страница для наглядного примера
